(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            let swiper;
            swiper = new swiper_core_Swiper(".swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                on: {
                    beforeTransitionStart: function() {
                        ...
                        let customShift = nextSlide ? nextSlide.offsetWidth + 35 : prevSlide ? prevSlide.offsetWidth + 35 : 500;
                        let newTranslate = -swiper.activeIndex * customShift;
                        swiper.wrapperEl.style.transition = `transform ${swiper.params.speed}ms ease`;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const hoursSpan = document.querySelector(".join__info-hours span");
        const minutesSpan = document.querySelector(".join__info-minutes span");
        const secondsSpan = document.querySelector(".join__info-seconds span");
        const startTime = 10 * 60 * 60 * 1e3;
